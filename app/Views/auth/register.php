...
<div class="auth-container">
    ...
    <h2><i class="fas fa-paw mr-2"></i>Daftar</h2>
    ...
    <form action="<?= base_url('auth/saveRegister') ?>" method="post">
        <div class="form-group">
            <label for="nama"><i class="fas fa-user mr-2"></i>Nama Lengkap</label>
            <input type="text" name="nama" id="nama" class="form-control" value="<?= old('nama') ?>" required pattern="[A-Za-z\s]+" title="Nama hanya boleh huruf dan spasi">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nomor_telepon" id="nomor_telepon" class="form-control" value="<?= old('nomor_telepon') ?>" required pattern="\d{10,}" title="Nomor telepon harus terdiri dari minimal 10 angka">
            <span class="input-icon"><i class="fas fa-phone"></i></span>
            <?php if (isset($validation) && $validation->getError('nomor_telepon')) : ?>
                <div class="text-danger"><?= $validation->getError('nomor_telepon') ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group">
            <label for="password_confirm"><i class="fas fa-lock mr-2"></i>Ulangi Kata Sandi</label>
        ...
        <button type="submit" class="btn btn-primary">
            <i class="fas fa-paw mr-2"></i>Daftar
        </button>
        <p class="mt-3">
            Sudah punya akun? 
