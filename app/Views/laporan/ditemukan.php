...
<div class="container mt-5">
    ...
    <form action="<?= base_url('laporan/saveDitemukan') ?>" method="post" enctype="multipart/form-data">
        <!-- Pet Information -->
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="nama_hewan" class="form-label">Nama Hewan (Jika Ada)</label>
                        ...
                        <div class="mb-3">
                            <label for="Ras_hewan" class="form-label">Ras Hewan (Jika Diketahui)</label>
                ...
                <div class="mb-3">
                    <label for="ciri_khas" class="form-label">Ciri Khas (Jika Ada)</label>
                    <textarea class="form-control" id="ciri_khas" name="ciri_khas" rows="2"></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" class="form-control" id="lokasi_ditemukan" name="lokasi_terakhir" 
...
<script>
    ...
    function initializeMap() {
        ...
        Microsoft.Maps.loadModule('Microsoft.Maps.Search', function () {
            ...
            document.getElementById('lokasi_ditemukan').addEventListener('keypress', function(e) {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    searchLocation();
                }
    ...
    function searchLocation() {
        let searchQuery = document.getElementById('lokasi_ditemukan').value;
        let requestOptions = {
            where: searchQuery,
            callback: function (answer) {
                if (answer.results && answer.results.length > 0) {
                    ...
                    document.getElementById('lokasi_ditemukan').value = answer.results[0].name;
                } else {
        ...
        let reverseGeocodeRequestOptions = {
            ...
            callback: function (answer) {
                if (answer.address && answer.address.formattedAddress) {
                    document.getElementById('lokasi_ditemukan').value = answer.address.formattedAddress;
                }
            }
        };
